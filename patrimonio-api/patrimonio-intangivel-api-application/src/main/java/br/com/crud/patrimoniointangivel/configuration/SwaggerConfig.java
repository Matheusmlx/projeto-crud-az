package br.com.azi.patrimoniointangivel.configuration;
...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = {"br.com.azi.patrimoniointangivel.entrypoint"})
public class SwaggerConfig {
    ...
    public Docket docketSwagger() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("br.com.azi.patrimoniointangivel.entrypoint"))
            .build()
            .apiInfo(metaData())
    ...
    private RelativePathProvider getPathProvider() {
        return new RelativePathProvider(servletContext) {
            ...
            public String getApplicationBasePath() {
                return "/patrimonio-intangivel/api/";
            }
        };
    }
