...
insert into pat_intangivel.tb_patrimonio (pa_id, pa_tipo, pa_nome, pa_descricao,nlc_id, pa_situacao, pa_estado, pa_valor_aquisicao, pa_reconhecimento, pa_dthr_aquisicao,
                                          pa_dthr_nl, pa_dthr_vencimento, uo_id_orgao, uo_id_setor, pa_vida_indefinida, cc_id)
values (1, 'SOFTWARES', 'Intellij', 'Descricao de software',2, 'EM_ELABORACAO', 'PRONTO_PARA_USO', 1000.00, 'AQUISICAO_SEPARADA', '2012-06-18T10:34:09', '2012-06-18T10:34:09', '2022-06-18T10:34:09', 10000, 10000, false, 2);
